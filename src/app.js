...
const ROUTES={splash,onboarding,today,thinking,judgement,execute,resumePrompt,practiceExit,reflect,journal,understanding,correctUnderstanding,humanModelCorrection,journey,settings,guide};
...
function saveReflection(value){
  ...
  const entry={...state.current,structuredReflection,outcomeAttribution,resolvedForecast,adaptationAccountability,practiceContractOutcome,practiceDoseRevisionUse,fallbackOutcome:fallbackOutcomeRecord(fallback,value),judgementId:state.current?.decision?.id||null,outcomeRecord,learningEligibility:eligibility,reflection:value,completed:true,completedAt:reflectedAt};
