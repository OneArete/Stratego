import { applyAdvisorMemory } from './advisor-memory.js?v=0670p1';
...
import { evidenceItem, assessEvidenceDiversity, detectContradictions } from './evidence-integrity.js?v=0670p1';
import { buildDeliberationTrace,buildMinorityReports,summarizeMinorityReports } from './deliberation-trace.js?v=0670p1';
import { applyLongitudinalAdjustments,longitudinalConfidenceAdjustment,verifyLongitudinalEvidence } from './longitudinal-evidence.js?v=0670p1';
import { applyConfirmedBeliefAdjustments } from './belief-system.js?v=0670p1';
import { applyCalibrationToConfidence,verifyCalibrationEvidence } from './calibration-governance.js?v=0670p1';
