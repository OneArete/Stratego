# GitHub files to replace — Strategos v0.63.0

Replace exactly the following files in the GitHub repository. Files not listed here are unchanged.

All runtime modules listed below were changed because the frozen startup-integrity rule requires one identical release token across every local and transitive JavaScript import.

- `CHANGELOG.md`
- `GITHUB-FILES-TO-REPLACE-v0.63.0.md`
- `README.md`
- `VERSION`
- `index.html`
- `package.json`
- `release/RELEASE-NOTES-v0.63.0.md`
- `service-worker.js`
- `src/app.js`
- `src/core/agora.js`
- `src/core/belief-system.js`
- `src/core/calibration-governance.js`
- `src/core/commitment-integrity.js`
- `src/core/daily-orientation.js`
- `src/core/daily-story.js`
- `src/core/engine.js`
- `src/core/evening-experience.js`
- `src/core/evidence-gate.js`
- `src/core/follow-through-integrity.js`
...
- `tests/commitment-integrity.test.js`
...
- `tests/judgement-scroll-continuity.test.js`
